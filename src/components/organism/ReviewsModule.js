...
class ReviewsModule extends Component{
    ...
    clearHoveredStars = () => {
        this.setState({
            ...
            indexHoverStar:(this.state.indexSelectedStar>=0)?this.state.indexSelectedStar:-1
        })
    }
                            ...
                            [...Array(5)].map((el,i) => {
                                ...
                                return (
                                    <FontAwesomeIcon color={
                                        (indexHoverStar===i)?"blue":"dark"
                                    }
                                        icon={
                                            indexHoverStar>=i || (indexSelectedStar>=i && indexHoverStar>=i)
                                                ?
                                                faStar
                                                :faRegStar
                                        }
